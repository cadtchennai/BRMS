 ...
 */
 ...
 (function($) {
	var lang = {
		...
		ru: {
			days: ['�?’Ñ�', '�?Ÿ�?½', '�?’Ñ‚', '�?¡Ñ€', '�?§Ñ‚', '�?ŸÑ‚', '�?¡�?±'],
			months: [ "�?¯�?½�?²", "�?¤�?µ�?²", "�?œ�?°Ñ€", "�?��?¿Ñ€", "�?œ�?°�?¹", "�?˜ÑŽ�?½", "�?˜ÑŽ�?»", "�?��?²�?³", "�?¡�?µ�?½", "�?ž�?ºÑ‚", "�?��?¾Ñ�", "�?�?�?µ�?º" ],
			format: 'DD.MM.YYYY hh:mm'
		},
		br: {
		...
		gr: {
			days: ['Îš�?…', 'Î�?Îµ', 'Î¤�?�', 'Î¤Îµ', 'Î Îµ', 'Î Î±', 'Î£Î±'],
			months: [ "Î™Î±Î½", "Î¦ÎµÎ²", "ÎœÎ±�?�", "Î‘�?€�?�", "ÎœÎ±�?Š", "Î™Î¿�?…Î½", "Î™Î¿�?…Î»", "Î‘�?…Î³", "Î£Îµ�?€", "ÎŸÎº�?„", "Î�Î¿Îµ", "Î�?ÎµÎº" ],
			sep: '-',
			format: 'DD-MM-YYYY hh:mm',
			prevMonth: 'Î �?�Î¿Î·Î³. Î¼Î®Î½Î±�?‚',
			nextMonth: 'Î•�?€�?ŒÎ¼. Î¼Î®Î½Î±�?‚',
			today: 'Î£Î®Î¼Îµ�?�Î±'
		}
	};
	/* ----- */
